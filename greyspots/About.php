    ...
    <div>
        <div class="container text-center">
            ...
            <p style="margin-top:0pt; margin-bottom:8pt; line-height:108%; font-size:16pt"><span style="color:#ffffff">People are becoming increasingly anxious as the Covid-19 outbreak continues to affect our society. Even
                ...
                contact with others. Students are extremely vulnerable under this circumstance, as they need to deal
                with pressures from both schoolwork and such safety concerns.<br/> GreySpots combine COVID-19 exposure
                data and pedestrian counting in Melbourne Central Business District (CBD) to provide data-driven
                guidelines for students who live in that area to become aware of risky places.<br/> GreySpots also
                provide predictability based on congested areas to avoid contracting the virus.</span></p>
