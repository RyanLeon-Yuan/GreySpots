...
<div class="main">
	...
	<script>
        ...
        var t1expIcon = new L.Icon({
            iconUrl: 'static/icons/t1exp.png',
        ...
        var t2expIcon = new L.Icon({
            iconUrl: 'static/icons/t2exp.png',
            shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
            iconSize: [25, 41],
            iconAnchor: [12, 41],
            popupAnchor: [1, -34],
        ...
        var t3expIcon = new L.Icon({
            iconUrl: 'static/icons/t3exp.png',
            shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
            iconSize: [25, 41],
            iconAnchor: [12, 41],
            popupAnchor: [1, -34],
        ...
        legend.onAdd = function (gsmap) {
            ...
            var div = L.DomUtil.create('div', 'info legend'),
                ...
                labels = ["/static/icons/t1exp.png", "/static/icons/t2exp.png","/static/icons/t3exp.png", "/static/icons/vacc.png", "/static/icons/test.png"];
