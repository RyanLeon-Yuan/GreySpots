            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-content text-center">
                        <h2 class="m-0">Covid-19 Testing</h2>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="activity-content mt-5 mt-lg-0">
                        ...
                        <div class="single-widget">
                            <h5>Instruction</h5>
                            <p>Here you can check for all the Covid-19 testing points. You can select the interested suburb from the drop down list by clicking on the ‘All Victoria’ button.</p>
                        </div>
            ...
            listContainer.get(0).innerHTML +=
                `<li class="single-tab-list d-flex align-items-center">
                        <div class="activity-content ml-4">
                            <a>
                                <h3 class="site_title mt-0 mb-2">${spot.Site_Name}</h3>
                            </a>
                        <p class="site_streetAddress m-0"><h5 class="site_title mt-0 mb-2">${spot.Address} ${spot.Suburb} ${spot.State} ${spot.Postcode}</h5>
                            <h6>${spot.Service_Availability}</h6>
                            Requirements: ${spot.Requirements}
                            <br>
                            ${spot.ServiceFormat}  ${spot.Facility}
                            <br>
