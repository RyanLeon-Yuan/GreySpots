            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-content text-center">
                        <h2 class="m-0">Exposure Site</h2>
                        <p>These premises have either had confirmed cases visit during their
                            infectious period or are sites where a confirmed case may have acquired their infection.
                            This does not mean that there is an ongoing risk associated with the premises. You can
                            safely visit the site in line with current restrictions. Search all Victorian public
                            exposure sites in the map or table below.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="activity-content mt-5 mt-lg-0">
                        ...
                        <div class="single-widget">
                            <h5>Instruction</h5>
                            <p>Here you can check for all the known exposure sites. You can select the interested suburb from the drop down list by clicking on the ‘All Victoria’ button.</p>
                        </div>
...
<script>
    ...
    $(() => {
        ...
        $.get('/dbes.php', (data) => {
            ...
            spots.sort((a, b) => {
                if (a.exposure_date < b.exposure_date) return 1
                else if (a.exposure_date == b.exposure_date) {
                    if (a.Exposure_time > b.Exposure_time) return 1
                    else return -1
                } else return -1
            })
            ...
            listContainer.get(0).innerHTML +=
                `<li class="single-tab-list d-flex align-items-center">
                        <div class="activity-content ml-4">
                            <a>
                                <h3 class="site_title mt-0 mb-2">${spot.Site_title}</h3>
                            </a>
                        <p class="site_streetAddress m-0">${spot.Site_streetaddress} ${spot.Suburb} ${spot.Site_state} ${spot.Site_postcode}
                            <br>
                            On ${spot.exposure_date} During ${spot.Exposure_time} that ${spot.Notes}
                        </p>
                        <span title='${spot.Advice_instruction}'>${spot.Advice_title}</span>
                        </div>
                    </li>`
        })
