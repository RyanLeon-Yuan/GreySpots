            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-7">
                    <div class="intro text-center">
                        <h3 class="mt-3 mb-0">Unsubscribe</h3>
                        <p>We look forward to seeing you again</p>
                    </div>
                    <!-- Item Form -->
                    <form id="contact-form" class="item-form card no-hover" method="POST" action="https://greyspots.tech/unsubscribe.php">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group mt-3">
                                    <textarea class="form-control" name="reason" placeholder="What makes you wish to unsubscribe?" cols="30" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn w-100 mt-3 mt-sm-4" type="submit"><i
                                            class="icon-paper-plane mr-2"></i>Unsubscribe
                                </button>
                            </div>
                        </div>
                    </form>
